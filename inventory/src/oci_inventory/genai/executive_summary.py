...
def _build_prompt(
    *,
    ...
    lines.append("- 3-5 short paragraphs, no bullet lists.")
    lines.append("- Provide a clear rationale: what the data suggests, why it matters, and what it implies for architecture posture.")
    lines.append("- Tailor insights to the observed signals (resource mix, compartment concentration, network footprint, workload patterns).")
