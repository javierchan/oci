...
exports.CohereMessageV2 = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var CohereMessageV2;
(function (CohereMessageV2) {
    function getJsonObj(obj) {
        ...
        if (obj && "role" in obj && obj.role) {
            switch (obj.role) {
                case "SYSTEM":
                    return model.CohereSystemMessageV2.getJsonObj(jsonObj, true);
                case "ASSISTANT":
                    return model.CohereAssistantMessageV2.getJsonObj(jsonObj, true);
                case "USER":
                    return model.CohereUserMessageV2.getJsonObj(jsonObj, true);
                case "TOOL":
                    return model.CohereToolMessageV2.getJsonObj(jsonObj, true);
                default:
    ...
    CohereMessageV2.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "role" in obj && obj.role) {
            switch (obj.role) {
                case "SYSTEM":
                    return model.CohereSystemMessageV2.getDeserializedJsonObj(jsonObj, true);
                case "ASSISTANT":
                    return model.CohereAssistantMessageV2.getDeserializedJsonObj(jsonObj, true);
                case "USER":
                    return model.CohereUserMessageV2.getDeserializedJsonObj(jsonObj, true);
                case "TOOL":
                    return model.CohereToolMessageV2.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.role}`);
            }
    ...
    CohereMessageV2.getDeserializedJsonObj = getDeserializedJsonObj;
})(CohereMessageV2 = exports.CohereMessageV2 || (exports.CohereMessageV2 = {}));
//# sourceMappingURL=cohere-message-v2.js.map