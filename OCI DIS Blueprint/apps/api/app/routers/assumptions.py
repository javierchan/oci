"""Assumptions router — versioned calculation assumptions and admin mutations."""
...
@router.post(
    ...
    summary="Create a versioned assumption set",
)
...
@router.patch("/{version}", response_model=AssumptionSetResponse, summary="Update an assumption set")
