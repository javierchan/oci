"""Catalog router — list, detail, patch, bulk patch, graph, and lineage."""
...
async def list_integrations(
    ...
    """Return paginated catalog rows using the service-backed catalog query path."""
...
@router.post(
    "/{project_id}",
    response_model=CatalogIntegrationResponse,
    status_code=status.HTTP_201_CREATED,
    summary="Create a catalog integration from manual capture",
)
async def create_integration(
    ...
    """Persist a governed manual-capture integration."""
...
@router.get(
    ...
    response_model=list[CatalogIntegrationResponse],
    summary="Check for duplicate source/destination/business process matches",
)
async def find_duplicates(
    ...
    """Return likely duplicates for the manual capture wizard."""
...
async def estimate_oic(
    ...
    """Return a live OIC estimate without persisting draft capture inputs."""
...
async def get_integration(
    ...
    """Return a catalog integration with source lineage and normalized source labels."""
...
async def update_integration(
    ...
    """Patch architect-owned fields through the auditable catalog service."""
...
async def bulk_patch(
    ...
    """Apply the same architect patch to multiple catalog integrations."""
...
async def get_lineage(
    ...
    """Return source row, import batch, raw values, and normalization events."""
...
async def delete_integration(
    ...
    """Delete a governed catalog integration through the service layer."""
