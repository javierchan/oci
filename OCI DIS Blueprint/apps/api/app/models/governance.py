...
class PatternDefinition(Base, UUIDMixin, TimestampMixin):
    ...
    applicability_examples: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
    selection_questions: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
...
class ServiceLimit(Base, UUIDMixin, TimestampMixin):
    ...
    constraint_kind: Mapped[str] = mapped_column(String(50), default="informational", nullable=False)
    enforcement: Mapped[str] = mapped_column(String(50), default="inform", nullable=False)
