...
HEADER_ALIASES: dict[str, list[str]] = {
    ...
    "brand": ["marca", "brand"],
    "business_process": ["proceso de negocio", "business process", "proceso", "process"],
    "interface_name": ["interfaz", "interface", "nombre interfaz"],
    "description": ["descripción", "descripcion", "description"],
    "type": ["tipo", "type"],
    "interface_status": ["estado interfaz", "interface status", "estado", "status"],
    "complexity": ["complejidad", "complexity"],
    "initial_scope": ["alcance inicial", "alcance", "scope"],
    "status": ["lifecycle status", "estado", "estado de interfaz"],
    ...
    "payload_per_execution_kb": ["tamaño kb", "payload por ejecución", "payload (kb)", "payload kb"],
    "tbq": ["tbq"],
