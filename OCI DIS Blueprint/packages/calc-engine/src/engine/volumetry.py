...
class Assumptions:
    ...
    streaming_max_message_kb: int = 1024
    streaming_max_message_size_mb: float = 1.0
    streaming_retention_days: int = 7
    streaming_default_partitions: int = 200
    streaming_get_rps_per_consumer_group_per_partition: int = 5
    streaming_max_consumer_groups_per_stream: int = 50
    streaming_max_partitions_muc: int = 200
    streaming_max_partitions_payg: int = 50
    functions_default_duration_ms: int = 2000
    functions_default_memory_mb: int = 256
    functions_default_concurrency: int = 1
    functions_max_invoke_body_kb: int = 6144
    functions_sla_pct: float = 99.5
    ...
    queue_max_inflight_messages: int = 100000
    queue_max_queues_per_region: int = 10
    queue_ingress_throughput_mb_s: int = 10
    queue_egress_throughput_mb_s: int = 10
    queue_max_storage_per_queue_gb: int = 2
    ...
    oic_max_invocation_depth: int = 16
    oic_sync_concurrency_new: int = 100
    oic_sync_concurrency_byol: int = 400
    oic_async_concurrency_new: int = 50
    ...
    api_gw_max_body_kb: int = 20_480
    api_gw_max_function_body_kb: int = 6_144
